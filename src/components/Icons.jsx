...
export default function Icons() {
  return (
    <svg style={{ display: 'none' }}>
      ...
      {/* Brand mark — a volleyball inside a map-pin marker, matching the
          favicon in index.html so the icon reads the same everywhere it
          shows up (Header, EventDetail, NotFound). */}
      <symbol id="i-logo" viewBox="0 0 100 130">
        <path d="M50 122C34 100 12 80 12 44A38 38 0 1 1 88 44C88 80 66 100 50 122Z" fill="#FF6B1A" />
        ...
        <g transform="translate(50,44)" fill="none" stroke="#FF6B1A" strokeWidth="4.4" strokeLinecap="round">
          <path d="M-25.98,15A30,30 0 0,1 25.98,15" />
          <path d="M-25.98,15A30,30 0 0,1 25.98,15" transform="rotate(120)" />
          <path d="M-25.98,15A30,30 0 0,1 25.98,15" transform="rotate(240)" />
        </g>
