...
- 活動探索、搜尋、多維度篩選（類型／性別／技能程度／價格／城市）
- 依篩選條件產生的**條件比對**狀態說明（不是個人化推薦，見下方設計決策）
- 活動報名（個人／揪團）、候補名單、取消與退款政策說明
- 收藏活動、瀏覽歷史
- 主辦方活動管理儀表板、建立活動流程
- 加入行事曆（.ics 下載）
- Profile：個人資料編輯、活動偏好、語言設定、隱私與資料說明、關於此原型、技術限制、重置示範資料

## Future Roadmap

**Phase 1（已完成）** — 活動探索、搜尋、篩選、收藏、報名、候補與活動管理的前端原型。

**Phase 2** — 正式帳號系統、會員登入、主辦方角色、跨裝置資料同步。
